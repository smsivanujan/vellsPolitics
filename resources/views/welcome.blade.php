                ...
                <div class="container py-2 d-md-flex flex-md-row">
                    ...
                    <div class="d-flex flex-row align-items-center">
                        ...
                        <p class="mb-0"><a href="mailto:sandbox@email.com"
                                class="link-white hover">sandbox@email.com</a></p>
                    </div>
                </div>
                <!-- /.container -->
            </div>
            ...
            <div class="container pt-8 pt-md-14">
                <div class="row gx-lg-0 gx-xl-8 gy-10 gy-md-13 gy-lg-0 mb-7 mb-md-10 mb-lg-16 align-items-center">
                    ...
                    <div class="col-lg-5 mt-lg-n10 text-center text-lg-start" data-cues="slideInDown"
                        ...
                        <p class="lead fs-25 lh-sm mb-7 px-md-10 px-lg-0">We have considered our solutions to support
                            every stage of your growth.</p>
                ...
                <div class="px-lg-5 mb-14 mb-md-17">
                    <div class="row gx-0 gx-md-8 gx-xl-12 gy-8 align-items-center">
                        <div class="col-4 col-md-2">
                            <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="./assets/img/brands/c1.png"
                                    alt="" /></figure>
                        </div>
                        <!--/column -->
                        <div class="col-4 col-md-2">
                            <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="./assets/img/brands/c2.png"
                                    alt="" /></figure>
                        </div>
                        <!--/column -->
                        <div class="col-4 col-md-2">
                            <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="./assets/img/brands/c3.png"
                                    alt="" /></figure>
                        </div>
                        <!--/column -->
                        <div class="col-4 col-md-2">
                            <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="./assets/img/brands/c4.png"
                                    alt="" /></figure>
                        </div>
                        <!--/column -->
                        <div class="col-4 col-md-2">
                            <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="./assets/img/brands/c5.png"
                                    alt="" /></figure>
                        </div>
                        <!--/column -->
                        <div class="col-4 col-md-2">
                            <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="./assets/img/brands/c6.png"
                                    alt="" /></figure>
                        </div>
                        <!--/column -->
                    </div>
                ...
                <div class="row">
                    <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6 mx-auto text-center">
                        ...
                        <h3 class="display-4 mb-10">The service we offer is specifically designed to meet your needs.
                        </h3>
                    </div>
                    <!-- /column -->
                </div>
                ...
                <div class="row gx-md-8 gy-8 text-center mb-14 mb-md-17">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <h4>24/7 Support</h4>
                        <p class="mb-3">Etiam porta sem malesuada magna mollis euismod. Donec ullamcorper nulla non
                ...
                <div class="row gy-10 gy-sm-13 gx-lg-3 align-items-center mb-14 mb-md-17 mb-lg-19">
                    ...
                    <div class="col-lg-5 col-xl-4 offset-lg-1">
                        ...
                        <p class="lead fs-lg mb-6">So here are three working steps why our valued customers choose us.
                        </p>
                            ...
                            <div class="col-lg-7 offset-lg-5 col-xl-6">
                                ...
                                <blockquote class="border-0 fs-lg mb-0">
                                    <p>“Fusce dapibus tellus ac cursus commodo, tortor mauris condimentum nibh ut
                                        fermentum massa, justo sit amet vivamus sagittis lacus vel augue laoreet rutrum
                                        faucibus dolor auctor. Cras mattis consectetur purus sit amet fermentum. Aenean
                                        lacinia bibendum nulla sed”</p>
